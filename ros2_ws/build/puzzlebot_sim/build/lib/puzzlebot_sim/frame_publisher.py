...
class FramePublisher(Node):
    ...
    def timer_callback(self):
        ...
        tf_odom_footprint.transform.translation.x = self.initial_pos_x + 0.5 * np.sin(self.omega * t)
        tf_odom_footprint.transform.translation.y = self.initial_pos_y + 0.5 * np.cos(-self.omega * t)
        tf_odom_footprint.transform.translation.z = 0.0
        q = transforms3d.euler.euler2quat(0, 0.0, self.initial_pos_yaw + -self.omega * t)
