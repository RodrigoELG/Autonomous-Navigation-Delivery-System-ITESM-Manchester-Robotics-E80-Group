    ...
    def timer_callback(self):
        ...
        if error < self.dist_tolerance:
            ...
            if abs(angle_error) > self.angle_tolerance:
                ...
                cmd_vel_msg.linear.x = np.clip(self.kp_v * error, -0.4, 0.4)  # Limit linear speed

            cmd_vel_msg.angular.z = np.clip(self.kp_w * angle_error, -1.0, 1.0) # Limit angular speed
